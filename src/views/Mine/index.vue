...
export default {
  ...
  methods: {
    ...
    async getMyCreations() {
      console.log(miningContract)
      const myCreations = await miningContract.getMyOwnedCreations(this.user.address);
      console.log('Creations', myCreations);
      this.myCreations = myCreations;
    },
